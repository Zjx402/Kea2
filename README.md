...
```
> Upgrade may fail if you're using mirror sites like Tsinghua or USTC because they may not have the latest version. In this case, you can try to install Kea2 by specifying the spcific version. Or use pypi.org directly by `pip install kea2-python -i https://pypi.org/simple`.
